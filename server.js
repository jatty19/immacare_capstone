...
//                     <p>Thank you for registering with ImmaCare+. Please verify your email address to activate your account.</p>
...
// --- Routes ---
app.get("/", (req, res) => res.redirect("/landingpage.html")); 
app.get("/landingpage.html", (req, res) => res.sendFile(path.join(__dirname, "public", "landingpage", "landing.html")));
app.get("/landing", (req, res) => {
    res.redirect("/landingpage.html");
});
